...
class Graphic:
    ...
    def __init__(self, windowWidth, windowHeight, leftRight, upDown):
        ...
        self.abschnitte = [Line(Point(0,0), Point(zellenBreite * 4, zellenHöhe * 4)), Line(Point((self.upDown + 2) * zellenBreite - 4 * self.zellenBreite, 4 * self.zellenHöhe), Point((self.upDown + 2) * zellenBreite, 0)),
